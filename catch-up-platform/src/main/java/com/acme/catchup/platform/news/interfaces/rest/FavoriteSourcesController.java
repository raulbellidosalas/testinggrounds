...
public class FavoriteSourcesController {
    ...
    @Operation(
            ...
            description = "Get a favorite source by its unique identifier."
    )
    @ApiResponses(value = {
    ...
    @Parameters({
            @Parameter(name = "newsApiKey", description = "The API key for the news service", required = true),
            @Parameter(name = "sourceId", description = "The unique identifier of the news source")
    })
    @GetMapping
